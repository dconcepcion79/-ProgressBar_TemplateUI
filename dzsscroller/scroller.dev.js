/*!
 * Bootstrap v3.0.2 
 * Copyright 2015-YIPTV, Inc.
 * 
 *
 * Designed and built by DavidC.
 */
...
//                console.info(cthis, is_ios(), is_android(), o.settings_disableSpecialIosFeatures);
                if ( (is_ios() || is_android()) && o.settings_disableSpecialIosFeatures != 'on') {
//                    console.info('hmm');
                ...
                if(_inner.get(0).style.height=='' || _inner.get(0).style.height=='auto'){
                ...
                if ( (is_ios() || is_android() ) && o.settings_disableSpecialIosFeatures == 'off') {
...
//                percomWidth = comWidth + 50;
            ...
            if (o.settings_scrollbyhover != 'on' && ( (is_ios() == false && is_android()==false) || o.settings_disableSpecialIosFeatures == 'on'))
...
//                console.log(e, e.axis, e.detail, cthis, _t);
            ...
            if ((is_ios() == false && is_android()==false) || o.settings_disableSpecialIosFeatures == 'on') {
...
//                return;
                ...
                var cthis_touch_comwidth = _inner.width() - cthis.width();
                var cthis_touch_left = _inner.position().left;
                var cthis_touch_comheight = _inner.height() - cthis.height();
                var cthis_touch_top = _inner.position().top;
                var sc = null;
                var scpar = null;
