...
//                cthis.addClass('toggle_type-'+ o.toggle_type);
            ...
            function reinit(){
                ...
                cthis.children('.dzs-tab-tobe:not(.processed)').each(function(){
                    var _t = $(this);
                    var aux_tab_menu = '<div class="tab-menu-con"><span class="tab-menu">'+_t.children('.tab-menu').html()+'</span><div class="tab-menu-content-con" style="height:0;"><div class="tab-menu-content">';
