...
include_once(dirname(__FILE__).'/location_writer.php');
$base_url ="http://".$_SERVER['HTTP_HOST'];  // DON'T TOUCH (base url (only domain) of site (without final /)).
$base_url=$location_url.'img/';

//$upload_dir = $location_url.'/img'; // path from base_url to base of upload folder (with start and final /)
//$upload_dir = str_replace($base_url, '', $upload_dir);

//echo $base_url.'<br>'.$upload_dir;
